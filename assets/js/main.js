...
(function($) {
    ...
    * ------------------------------------------------------ */
    ...
    // Cache elements for performance and reusability
    const visitorCountElement = document.getElementById('visitor-count');
    const yearSpan = document.getElementById('year');
    
    // Fetch visitor count asynchronously
    async function fetchVisitorCount() {
        try {
            ...
            visitorCountElement.innerText = `${data.visitorCount}`; // Update visitor count
        }catch (error) {
    ...
    function updateYear() {
        if (yearSpan) {
            yearSpan.innerHTML = `&copy; AttA ${new Date().getFullYear()}`;
        }
        else {
